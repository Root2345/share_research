...
parser.add_argument('--nClasses',       type=int,   default=2086,   help='Number of speakers in the softmax layer, only for softmax-based losses')
...
# parser.add_argument('--save_path',      type=str,   default="/home/s226059/workspace/self_sinctdnn/save_model/agevc_xvec_reduce2", help='Path for model and logs')
...
# parser.add_argument('--train_list',     type=str,   default="/home/s226059/workspace/data/age_training/wav/utt2spk_reduce.train",  help='Train list')
